                ...
                foreach( $subscription_plan_groups as $top_parent_id => $subscription_plans ) {
                    ...
                    if( !$member ) {
                        ...
                        foreach( $subscription_plans as $subscription_plan ) {
                            ...
                            $subscription_plan_output .= apply_filters( 'pms_output_subscription_plan_name', $subscription_plan->name, $subscription_plan ) . '</label>';
                            ...
                            // Description
                            if( !empty($subscription_plan->description) )
                                $subscription_plan_output .= '<div class="pms-subscription-plan-description">' . apply_filters( 'pms_output_subscription_plan_description', $subscription_plan->description, $subscription_plan )  . '</div>';
